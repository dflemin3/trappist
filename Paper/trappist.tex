...
\centering
   ...
   \caption{Same format as Fig.~\ref{fig:corner} with the MCMC constraints from Fig.~\ref{fig:corner} in black and the \approxposterior constraints in blue.}%
    \label{fig:stacked}%
\end{figure*}

We compare the results of our \approxposterior run with our MCMC analysis in Fig.~\ref{fig:stacked}.
...
Note speed-ups will only grow when \approxposterior is used with slower forward models.
